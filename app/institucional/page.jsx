        ...
        <div className="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-10 lg:mt-20">
            <div className="flex flex-col items-center justify-center p-6 rounded-lg bg-white shadow-md">
              ...
              />
              <h4 className="font-staatliches  mt-6 text-lg font-extrabold">
                Ricardo Quintela
              </h4>
        ...
        <div className="flex flex-col lg:flex-row">
          <div className="flex-1 lg:pr-8">
            ...
            <p className="font-staatliches text-gray-800 text-lg md:text-xl lg:text-2xl mb-6 border-none">
              <span className="font-bold">Polo Tecnológico La Rioja,</span> está
              trabajando de forma activa para poder brindar soluciones y generar
              nuevos vínculos. Es por ello que desarrollamos un lugar donde
              tanto empresas como talentos especializados pueden formar un
              vínculo para poder generar proyectos de desarrollo.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h6 className="text-4xl font-bold text-gray-700">
              ¡Estamos construyendo el Futuro y estas empresas nos ayudan a
              hacerlo!
            </h6>
          </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="max-w-2xl mx-auto text-center px-4 mb-12">
          ...
          <p className="text-2xl text-gray-700">
            En este panel encontrarás algunas de las preguntas que nos realizan
            nuestros usuarios.
          </p>
        </div>
          ...
          {accordionItems.map((item, index) => (
            ...
            >
              <h2 id={`accordion-heading-${index}`}>
                ...
                >
                  <span className="font-staatliches text-lg sm:text-xl lg:text-2xl font-bold">
                    {item.title}
                  </span>
                  <svg
                    aria-hidden="true"
