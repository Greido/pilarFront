...
const Footer = () => {
  ...
  <div className="container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
    ...
    <div className="flex flex-wrap w-full lg:w-3/4">
      <ul className="w-full p-0 mb-6 lg:mb-0 lg:w-1/3">
        <li>
          <a href="#_" className="inline-block px-3 py-2 text-gray-400 hover:text-gray-300">
            Principal
          </a>
        </li>
        <li>
      ...
      <div className="w-full lg:w-1/3">
        ...
        <div className="flex justify-center lg:justify-start mt-2">
          ...
          <a
            className="flex items-center block mr-6 text-gray-400 hover:text-gray-300"
            target="_blank"
            rel="noopener noreferrer"
            href="https://devdojo.com"
          >
  ...
  <div className="pt-15 mt-10 text-center text-red-500 border-t border-gray-700 font-extrabold">
    © 2020 Desarrollado por : Dirección General de Economia del Conocimiento
  </div>
</footer>
